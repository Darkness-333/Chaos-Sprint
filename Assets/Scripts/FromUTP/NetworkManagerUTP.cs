...
namespace Network 
{
    public class NetworkManagerUTP : RelayNetworkManager
    {
        /// <summary>
        /// The local player object that spawns in.
        /// </summary>
        public PlayerUTP localPlayer;
        ...
        /// </summary>
        private List<PlayerUTP> m_Players;

        public override void Awake()
        {
            base.Awake();
            m_Players = new List<PlayerUTP>();
        ...
        public override void OnServerAddPlayer(NetworkConnectionToClient conn)
        {
            ...
            {
                PlayerUTP comp = kvp.Value.GetComponent<PlayerUTP>();
        ...
        public override void OnServerDisconnect(NetworkConnectionToClient conn)
        {
            ...
            foreach (PlayerUTP player in m_Players)
            {
        ...
        void FindLocalPlayer()
        {
            ...
            localPlayer = NetworkClient.localPlayer.GetComponent<PlayerUTP>();
        }
    }
}
