...
namespace UI
{
	...
	[RequireComponent(typeof(NetworkManagerUTP))]
	[EditorBrowsable(EditorBrowsableState.Never)]
	[HelpURL("https://mirror-networking.com/docs/Components/NetworkManagerHUD.html")]
	public class GUIMenuUTP : MonoBehaviour
	{
		private NetworkManagerUTP m_Manager;
		...
		void Awake()
		{
			m_Manager = GetComponent<NetworkManagerUTP>();
		}
